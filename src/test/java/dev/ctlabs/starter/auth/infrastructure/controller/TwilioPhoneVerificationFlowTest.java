...
class TwilioPhoneVerificationFlowTest {
    ...
    void registerShouldGenerateCodeWhenPhoneProviderIsTwilio() throws Exception {
        var request = new RegisterRequest("Twilio", "User", null, "+1234567890", "Password123!");
    ...
    void loginShouldFailWhenPhoneNotVerified() throws Exception {
        var registerRequest = new RegisterRequest("Twilio", "Login", null, "+19998887777", "Password123!");
        ...
        var loginRequest = new LoginRequest("+19998887777", "Password123!");
